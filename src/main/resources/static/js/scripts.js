...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["I am a system to management your club.", "I manage all kind of club.", "I was developed by João Kiakumbo."],    /* You can change the home section typing text from
